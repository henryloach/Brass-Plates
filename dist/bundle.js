...
const getFontSizeToFit = (plate) => {
    ...
    tempText.setAttribute("font-size", `${_data__WEBPACK_IMPORTED_MODULE_0__.defaultFontSize}mm`);
    tempText.textContent = text;
    svg.appendChild(tempText);
    const textWidth = tempText.getComputedTextLength();
    document.body.removeChild(svg);
    if (textWidth <= maxWidthPx)
        return _data__WEBPACK_IMPORTED_MODULE_0__.defaultFontSize;
    return _data__WEBPACK_IMPORTED_MODULE_0__.defaultFontSize * (maxWidthPx / textWidth);
};
...
const unitText = (index, plate) => {
    ...
    const fontSize = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getFontSizeToFit)(plate);
...
const editTextInput = (model, dispatch) => {
    ...
    const [row, column] = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getRowAndColumn)(index);
    let [x, y] = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getPlatePosition)(index, 'topLeft');
    [x, y] = [x + _data__WEBPACK_IMPORTED_MODULE_2__.bodyMargin, y + _data__WEBPACK_IMPORTED_MODULE_2__.bodyMargin];
    const fontSize = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getFontSizeToFit)(plate);
