...
const { div, button, svg, pre, form, input, select, option } = hyperscript_helpers__WEBPACK_IMPORTED_MODULE_1___default()(snabbdom__WEBPACK_IMPORTED_MODULE_0__.h);
...
const editInput = (model, dispatch) => {
    ...
    const textInput = input({
        ...
        style: {
            ...
            left: `${x}mm`,
            top: `${y}mm`,
            width: `${_data__WEBPACK_IMPORTED_MODULE_2__.plateSizeX * 3 / 4}mm`,
            height: `${_data__WEBPACK_IMPORTED_MODULE_2__.plateSizeY}mm`,
            'text-align': 'center'
        },
        hook: {
