    ...
    return [
        ...
        (0,snabbdom__WEBPACK_IMPORTED_MODULE_0__.h)('line', {
            attrs: {
                ...
                x2: `${x + _data__WEBPACK_IMPORTED_MODULE_2__.plateSizeX}mm`,
...
const unitText = (index, plate) => {
    ...
    const baseLineCorrection = fontSize * _data__WEBPACK_IMPORTED_MODULE_2__.fontMap[plate.font].baselineCorrection;
...
const editFontInput = (model, dispatch) => {
    ...
    const fontInput = select({
        ...
        return option({
            ...
            style: {
                'font-family': _data__WEBPACK_IMPORTED_MODULE_2__.fontMap[name]['font-family'].web,
